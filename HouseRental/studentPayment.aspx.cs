    ...
    public partial class studentPayment : System.Web.UI.Page
    {
        ...
        void getPaymentDetails()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("SELECT * from payment WHERE details='" + TextBox1.Text.Trim() + "' AND studentID='" + Session["ID"].ToString() + "';", con);
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                DataTable dt = new DataTable();
                da.Fill(dt);
        ...
        protected void btnPayment_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect(string.Format("~/paymentGateway.aspx?details={0}&date={1}&price={2}&latefee={3}&total={4}", details, date, price, latefee, total));
        }
        ...
        protected void Confirm_View(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("SELECT * from payment WHERE details='" + Label2.Text.Trim() + "' AND studentID='" + Session["ID"].ToString() + "'", con);
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataTable dt = new DataTable();
            da.Fill(dt);
