<%@ Page Title="" Language="C#" MasterPageFile="~/student.master" AutoEventWireup="true" CodeBehind="studentContract.aspx.cs" Inherits="HouseRental.studentContract" %>
...
<!-- ============================================================== -->
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                       <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:houserentalDBConnectionString %>" SelectCommand="SELECT [ID], [landlord_name], [house_name], [date] FROM [contract] WHERE ([student_name] = @student_name)">
                          <SelectParameters>
                              <asp:SessionParameter Name="student_name" SessionField="name" Type="String" />
                          </SelectParameters>
                      </asp:SqlDataSource>
                     <div class="col">
                         <asp:GridView class="table table-striped table-bordered" ID="GridView2" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" DataKeyNames="ID" OnRowDataBound="GridView2_RowDataBound" CellPadding="4" ForeColor="#333333" GridLines="None" OnSelectedIndexChanged="GridView2_SelectedIndexChanged" >
                            ...
                            <Columns>
                               <asp:BoundField DataField="ID" HeaderText="ID" SortExpression="ID" InsertVisible="False" ReadOnly="True" Visible="false" />
                                <asp:BoundField DataField="landlord_name" HeaderText="Landlord" SortExpression="landlord_name" />
...
<!-- ============================================================== -->
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <asp:Button Text="Download Contract" class="btn btn-primary" OnClick="GenerateInvoicePDF" runat="server" />
                        </div>
                    </div>
                    <!-- /.modal-content -->
                </div>
