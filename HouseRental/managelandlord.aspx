...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <button type="button"  id="btnShowPopup" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal"> Add New Landlord</button>                      
                    <!-- ============================================================== -->
			<div class="card">
               <div class="card-body">
                  <div class="row">
                      <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:houserentalDBConnectionString %>" SelectCommand="SELECT [name], [email], [contactnum], [gender], [accountstatus] FROM [people] WHERE ([usertype] = @usertype)">
                          <SelectParameters>
                        ...
                        <asp:GridView class="table table-striped table-bordered" ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1">
                            <Columns>
								...
								<asp:TemplateField HeaderText="Action">
									<ItemTemplate>
										<asp:LinkButton ID="LinkButton1" CommandName="Verify" Cssclass="btn btn-info" runat="server" Text="Verify"  />
										<asp:LinkButton ID="LinkButton2" CommandName="View" Cssclass="btn btn-success" runat="server" Text="View" />
										<asp:LinkButton ID="LinkButton3" CommandName="Delete" CssClass="btn btn-danger" runat="server" Text="Remove" />
									</ItemTemplate>
								</asp:TemplateField>
                            </Columns>
                         </asp:GridView>
