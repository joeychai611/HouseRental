...
namespace HouseRental
{
    public partial class managepayment : System.Web.UI.Page
    {
        ...
        protected void GridView2_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            TextBox2.Text = GridView2.SelectedRow.Cells[3].Text;
            TextBox3.Text = GridView2.SelectedRow.Cells[2].Text;
            TextBox7.Text = GridView2.SelectedRow.Cells[9].Text;
        ...
        void getPaymentDetails()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("SELECT * from payment LEFT JOIN people on payment.studentID=people.ID WHERE payment.details='" + TextBox1.Text.Trim() + "' AND payment.studentID='" + TextBox7.Text.Trim() + "'", con);
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                DataTable dt = new DataTable();
                da.Fill(dt);
